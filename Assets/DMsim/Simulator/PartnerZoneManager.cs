...
public class PartnerZoneManazer : ZoneManager
{
    [SerializeField] private GameObject PartnerOpenUnderlay;
    public bool isPartnerOpen = false;
    ...
    {
        isPartnerOpen = true;
        PartnerOpenUnderlay.SetActive(true);
        ArrangeCardsWhenOpen();
    ...
    {
        isPartnerOpen = false;
        PartnerOpenUnderlay.SetActive(false);
        ArrangeCards();
    }
}
